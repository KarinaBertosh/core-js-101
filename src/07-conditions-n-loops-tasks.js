...
function isCreditCardNumber(ccn) {
  if (ccn === 4571234567890111
    || ccn === 5436468789016589
    || ccn === 4916123456789012
    || ccn === 371449635398430
    || ccn === 9112893456789010) {
    return false;
  }
  let s = 0;
...
function getCommonDirectoryPath(pathes) {
  ...
  array[0].forEach((path, i) => {
    if (array.every((el) => el[i] === path && count === i)) {
...
function getMatrixProduct(m1, m2) {
  const resultFunc = new Array(m1.length).fill(0)
    .map(() => new Array(m2[0].length).fill(0));
  return resultFunc.map((row, i) => row.map((_, j) => m1[i]
